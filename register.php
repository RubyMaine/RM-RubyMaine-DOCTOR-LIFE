			...
			<div class="card">
				...
				<div class="card-body">
					<form method="post" id="patient_register_form">
						...
						<div class="form-group">
							<label> Введите ваш пароль <span class="text-danger">*</span></label>
						...
						<div class="form-group text-center">
							...
							<input type="submit" name="patient_register_button" id="patient_register_button" class="btn btn-primary" value=" Регистрация " />
						</div>
