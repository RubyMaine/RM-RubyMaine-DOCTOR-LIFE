...
if(isset($_POST["action"]))
{
	if($_POST["action"] == 'fetch')
	{
		...
		foreach($result as $row)
		{
			...
			{
				$status = '<span class="badge badge-success"> Принять! </span>';
			}
			else
			{
				$status = '<span class="badge badge-danger"> Не принять! </span>';
			}
			$sub_array[] = $status;
			$sub_array[] = '
			<div align="center">
	...
	if($_POST["action"] == 'fetch_single')
	{
		...
		foreach($result as $row)
		{
			...
			if($row['email_verify'] == 'Yes')
			{
				$data['email_verify'] = '<span class="badge badge-success"> Принять! </span>';
			}
			else
			{
				$data['email_verify'] = '<span class="badge badge-danger"> Не принять! </span>';
			}
		}
