...
?>
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800"> Управление назначением </h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <div class="row">
                <div class="col-sm-6">
                    <h6 class="m-0 font-weight-bold text-danger"> Список назначений </h6>
                </div>
        ...
        <form method="post" id="edit_appointment_form">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="modal_title">Посмотреть сведения о встрече </h4>
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" name="save_appointment" id="save_appointment" class="btn btn-success" value=" Сохранить " />
