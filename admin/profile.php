    ...
    <form method="post" id="profile_form" enctype="multipart/form-data">
        <div class="row"><div class="col-md-8"><span id="message"></span><div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col">
                        <h6 class="m-0 font-weight-bold text-danger"> Редактировать профиль: </h6>
                    </div>
                    <div clas="col" align="right">
                        <input type="hidden" name="action" value="admin_profile" />
                        <button type="submit" name="edit_button" id="edit_button" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i> Редактировать </button>
                        &nbsp;&nbsp;
                    </div>
                </div>
            </div>
                ...
                <!--<div class="row">
                    <div class="col-md-6">!-->
                        <div class="form-group">
                            <label><i class="fas fa-edit"></i> Имя администратора: </label>
                        ...
                        <div class="form-group">
                            <label><i class="fas fa-mail-bulk"></i> Электронной почты администратора: </label>
                        ...
                        <div class="form-group">
                            <label><i class="fas fa-key"></i> Пароль администратора: </label>
