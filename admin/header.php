    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard.php">
                ...
                <div class="sidebar-brand-text mx-3"> RubyMaine Doctor Life </div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="dashboard.php">
                    ...
                    <span> Панель управление </span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="doctor.php">
                    <i class="fas fa-user-md"></i>
                    <span> Список врачей </span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="patient.php">
                    <i class="fas fa-procedures"></i>
                    <span> Список пациентов </span></a>
            </li>
            <?php
            }
            ?>
            <li class="nav-item">
                <a class="nav-link" href="doctor_schedule.php">
                    ...
                    <span> Расписания врачей </span></a>
            </li>
            
            <li class="nav-item">
                <a class="nav-link" href="appointment.php">
                    <i class="fas fa-notes-medical"></i>
                    <span> Список назначений </span></a>
            </li>
            <?php
            if($_SESSION["type"] == 'Admin')
            {
