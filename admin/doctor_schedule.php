...
?>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800"> Управление расписанием врачей </h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                        	<div class="row">
                            	<div class="col">
                            		<h6 class="m-0 font-weight-bold text-danger"> Список расписания врачей </h6>
                            	</div>
    	...
    	<form method="post" id="doctor_schedule_form">
      		<div class="modal-content">
        		<div class="modal-header">
          			<h4 class="modal-title" id="modal_title"> Добавить нового расписание врача </h4>
        		...
        		<div class="modal-body">
                    ...
                    <div class="form-group">
                        <label> Среднее время консультации: </label>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class="fas fa-clock"></i></span>
                            </div>
                            <select name="average_consulting_time" id="average_consulting_time" class="form-control" required>
                                <option value=""> Среднее время консультации: </option>
                                <?php
                                $count = 0;
                                for($i = 1; $i <= 15; $i++)
                                {
                                    $count += 5;
                                    echo '<option value="'.$count.'">'.$count.' Минут! </option>';
                                }
                                ?>
                            </select>
                        </div>
        		...
        		<div class="modal-footer">
          			...
          			<input type="hidden" name="action" id="action" value=" Добавить " />
          			<input type="submit" name="submit" id="submit_button" class="btn btn-success" value=" Добавить " />
...
$(document).ready(function(){
	...
	$('#add_doctor_schedule').click(function(){
    	...
    	$('#modal_title').text(' Добавить данные расписания врача ');
	...
	$(document).on('click', '.edit_button', function(){
		...
		$.ajax({
	      	...
	      	success:function(data)
	      	{
	        	...
	        	$('#modal_title').text(' Изменить данные расписания врача ');
