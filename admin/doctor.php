...
?>
	...
	<!-- Page Heading -->
	<h1 class="h3 mb-4 text-gray-800"> Доктор менеджмент </h1>
	...
	<div class="card shadow mb-4">
		<div class="card-header py-3">
			<div class="row">
				<div class="col">
					<h6 class="m-0 font-weight-bold text-danger"> Список врачей: </h6>
				</div>
    	...
    	<form method="post" id="doctor_form">
      		<div class="modal-content">
        		<div class="modal-header">
          			<h4 class="modal-title" id="modal_title"> Добавить нового доктора: </h4>
        		...
        		<div class="modal-body">
        			<span id="form_message"></span>
		          	<div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                <label> Электронной почты <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <label> Пароль доктора <span class="text-danger">*</span></label>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                <label> Имя доктора <span class="text-danger">*</span></label>
                                <input type="text" name="doctor_name" id="doctor_name" class="form-control" required data-parsley-trigger="keyup" />
                            </div>
                            <div class="col-md-6">
                                <label> Телефон врача <span class="text-danger">*</span></label>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label> Дата рождения доктора <span class="text-danger">*</span></label>
        		...
        		<div class="modal-footer">
          			...
          			<input type="hidden" name="action" id="action" value=" Добавлять " />
          			<input type="submit" name="submit" id="submit_button" class="btn btn-success" value=" Добавлять " />
...
<div id="viewModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="modal_title"> Посмотреть сведения о докторе: </h4>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
...
$(document).ready(function(){
	...
	$('#add_doctor').click(function(){
    	...
    	$('#action').val(' Добавлять ');

    	$('#submit_button').val(' Добавлять ');
	...
	$(document).on('click', '.edit_button', function(){
		...
		$.ajax({
	      	...
	      	success:function(data)
	      	{
	        	...
	        	$('#modal_title').text(' Изменить данные: ');

	        	$('#action').val(' Редактировать ');

	        	$('#submit_button').val(' Редактировать ');
	...
	$(document).on('click', '.status_button', function(){
		...
		if(confirm("Вы уверены, что хотите "+next_status+" это?"))
    	{
    ...
    $(document).on('click', '.view_button', function(){
        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                html += '<tr><th width="40%" class="text-right"> Электронной почты врача: </th><td width="60%">'+data.doctor_email_address+'</td></tr>';

                html += '<tr><th width="40%" class="text-right"> Пароль врача: </th><td width="60%">'+data.doctor_password+'</td></tr>';

                html += '<tr><th width="40%" class="text-right"> Имя врача: </th><td width="60%">'+data.doctor_name+'</td></tr>';

                html += '<tr><th width="40%" class="text-right"> Телефон врача: </th><td width="60%">'+data.doctor_phone_no+'</td></tr>';

                html += '<tr><th width="40%" class="text-right"> Адрес врача: </th><td width="60%">'+data.doctor_address+'</td></tr>';

                html += '<tr><th width="40%" class="text-right"> Дата рождения врача: </th><td width="60%">'+data.doctor_date_of_birth+'</td></tr>';

                html += '<tr><th width="40%" class="text-right"> Квалификация врача: </th><td width="60%">'+data.doctor_degree+'</td></tr>';

                html += '<tr><th width="40%" class="text-right"> Специальность врача: </th><td width="60%">'+data.doctor_expert_in+'</td></tr>';
